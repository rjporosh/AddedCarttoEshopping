...
namespace Ecommerce.DatabaseContext.Migrations
{
    ...
    [Migration("20191007082300_one and only migration after deleting old")]
    partial class oneandonlymigrationafterdeletingold
    {
            ...
            modelBuilder.Entity("Ecommerce.Models.Product", b =>
                {
                    ...
                    b.Property<long?>("ProductVariantsId1");
                    ...
                    b.HasIndex("ProductVariantsId")
                        .IsUnique()
                        .HasFilter("[ProductVariantsId] IS NOT NULL");

                    b.HasIndex("ProductVariantsId1");
            ...
            modelBuilder.Entity("Ecommerce.Models.Product", b =>
                {
                    ...
                    b.HasOne("Ecommerce.Models.ProductVariants", "ProductVariants")
                        .WithOne("Product")
                        .HasForeignKey("Ecommerce.Models.Product", "ProductVariantsId");

                    b.HasOne("Ecommerce.Models.ProductVariants")
                        .WithMany("ProductList")
                        .HasForeignKey("ProductVariantsId1");
